...
我完全理解开发者们因为这些困境去抱怨 Redux，React，函数式编程，不可变性以及一些其他让他们不舒服的概念/工具的心情。将 Redux 与 不需要模板代码也可以执行状态更新的方法 进行比较是很自然的事情，并且得出 Redux 只是复杂的代名词的结论也“理所当然”。某种程度来说，Redux 的设计就是这样的。
...
虽然过去也使用 Javascript，但是我们讨论更多像是 Jquery sliders 插件和其他一些用来制造完全不需要的波动效果的的库...
