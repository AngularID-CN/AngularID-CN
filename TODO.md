...
113 | [Here is why appendChild moves a DOM node between parents](https://blog.angularindepth.com/here-is-why-appendchild-moves-a-dom-node-instead-of-cloning-it-f8ef7a31735c?source=---------21---------------------) | - | dreamdevil00  |  | 翻译完毕 |  [appendChild 会在父节点间移动 DOM 节点的原因](articles/angular-113.[翻译]-appendChild-会在父节点间移动-DOM-节点的原因.md)
